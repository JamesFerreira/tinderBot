...
class TinderLogin:
    ...
    def __logInViaFacebook(self):
        driver = self.driver
        button = driver.find_element_by_xpath('/html/body/div[2]/main/div/div/div[1]/div/div[3]/span/div[2]/button')
    ...
    def __closePopups(self):
        driver = self.driver
        #sleep(999999999)
        # driver.find_element_by_xpath('/html/body/div[2]/main/div/div/div/div[3]/button[1]').click()
